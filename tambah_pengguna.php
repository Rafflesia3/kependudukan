  ...
  <br>
        <div class="container">
            <div class="panel panel-primary" style="width:750px;margin:0px auto">
              <div class="panel-heading"><font size="3" face="verdana"><b><center>Form Input pengguna</center></b></font></div>
              <div class="panel-body">
              <form method="post" action="input_pengguna.php" enctype="multipart/form-data" data-toggle="validator" role="form">
                <div class="form-group">
                  <label for="exampleInputnama1">nama pengguna</label>
                ...
                <div class="form-group">
                 ...
                 <div class="text-left">
                  <a href="data_pengguna.php"  data-toggle="tooltip" class="tip-bottom" data-original-title="Tooltip Dibawah">View All Data pengguna <i class="fa fa-arrow-circle-left"></i></a>
                </div>
                </form>
              </div>
            </div>
